...
namespace Microsoft.EntityFrameworkCore.SqlServer.Query.Internal
{
    public class SearchConditionConvertingExpressionVisitor : SqlExpressionVisitor
    {
        ...
        protected override Expression VisitSqlUnary(SqlUnaryExpression sqlUnaryExpression)
        {
            ...
            //// !(a == b) -> (a != b)
            //// !(a != b) -> (a == b)
            //return result is SqlUnaryExpression sqlUnaryResult
            //    && sqlUnaryResult.OperatorType == ExpressionType.Not
            //    && (sqlUnaryResult.Type == typeof(bool) || sqlUnaryResult.Type == typeof(bool?))
            //    && sqlUnaryResult.Operand is SqlBinaryExpression sqlBinaryOperand
            //    && (sqlBinaryOperand.OperatorType == ExpressionType.Equal || sqlBinaryOperand.OperatorType == ExpressionType.NotEqual)
            //    ? _sqlExpressionFactory.MakeBinary(
            //        sqlBinaryOperand.OperatorType == ExpressionType.Equal
            //            ? ExpressionType.NotEqual
