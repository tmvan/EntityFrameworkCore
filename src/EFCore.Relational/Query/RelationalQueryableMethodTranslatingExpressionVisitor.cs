    ...
    public class RelationalQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
    {
        ...
        protected override ShapedQueryExpression TranslateCast(ShapedQueryExpression source, Type resultType)
        {
            ...
            return source.ShaperExpression.Type != resultType
                ? source.UpdateShaper(Expression.Convert(source.ShaperExpression, resultType))
                : source;
        }
        ...
        protected override ShapedQueryExpression TranslateCount(ShapedQueryExpression source, LambdaExpression predicate)
        {
            ...
            return source.UpdateShaper(new ProjectionBindingExpression(source.QueryExpression, new ProjectionMember(), typeof(int)));
        }
        ...
        protected override ShapedQueryExpression TranslateDefaultIfEmpty(ShapedQueryExpression source, Expression defaultValue)
        {
            ...
            if (defaultValue == null)
            {
                ...
                return source.UpdateShaper(MarkShaperNullable(source.ShaperExpression));
            }
            ...
            ShapedQueryExpression source, LambdaExpression predicate, Type returnType, bool returnDefault)
        {
            ...
            return source.ShaperExpression.Type != returnType
                ? source.UpdateShaper(Expression.Convert(source.ShaperExpression, returnType))
                : source;
        }
            ...
            LambdaExpression resultSelector)
        {
            ...
            if (translatedKey != null)
            {
                ...
                {
                    return source.UpdateShaper(groupByShaper);
                }
                ...
                return source.UpdateShaper(_projectionBindingExpressionVisitor.Translate(selectExpression, newResultSelectorBody));
            }
        ...
        protected override ShapedQueryExpression TranslateLongCount(ShapedQueryExpression source, LambdaExpression predicate)
        {
            ...
            selectExpression.ClearOrdering();
            selectExpression.ReplaceProjectionMapping(projectionMapping);
            return source.UpdateShaper(new ProjectionBindingExpression(source.QueryExpression, new ProjectionMember(), typeof(long)));
        }
        ...
        protected override ShapedQueryExpression TranslateOfType(ShapedQueryExpression source, Type resultType)
        {
            ...
            if (source.ShaperExpression is EntityShaperExpression entityShaperExpression)
            {
                ...
                if (baseType != null)
                {
                    return source.UpdateShaper(entityShaperExpression.WithEntityType(baseType));
                }
                ...
                if (derivedType != null)
                {
                    ...
                    return source.UpdateShaper(entityShaperExpression.WithEntityType(derivedType));
                }
        ...
        protected override ShapedQueryExpression TranslateSelect(ShapedQueryExpression source, LambdaExpression selector)
        {
            ...
            return source.UpdateShaper(_projectionBindingExpressionVisitor.Translate(selectExpression, newSelectorBody));
        }
            ...
            ShapedQueryExpression source, Expression projection, bool throwOnNullResult, Type resultType)
        {
            ...
            return source.UpdateShaper(shaper);
        }
    }
}
