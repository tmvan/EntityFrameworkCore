...
namespace Microsoft.EntityFrameworkCore.Query.Internal
{
    public class NullSemanticsRewritingExpressionVisitor : NullabilityComputingSqlExpressionVisitor
    {
        ...
        protected override SqlExpression OptimizeSqlBinaryExpression(SqlBinaryExpression sqlBinaryExpression, bool leftNullable, bool rightNullable)
        {
            ...
            {
                var leftConstantNull = left is SqlConstantExpression leftConstant && leftConstant.Value == null;
                var rightConstantNull = right is SqlConstantExpression rightConstant && rightConstant.Value == null;
                ...
                if (rightConstantNull)
                {
                    ...
                    return sqlBinaryExpression.OperatorType == ExpressionType.Equal
                        ...
                        : _sqlExpressionFactory.IsNotNull(left);
                }
                ...
                if (leftConstantNull)
                {
                    ...
                    return sqlBinaryExpression.OperatorType == ExpressionType.Equal
                        ...
                        : _sqlExpressionFactory.IsNotNull(right);
                }
                ...
                if (OptimizeNullComparison//canOptimize <- IDK IF THIS IS RIGHT!!!!!!!!!!!!!
