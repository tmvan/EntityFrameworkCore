...
namespace Microsoft.EntityFrameworkCore
{
        ...
        where TFixture : MigrationsTestBase<TFixture>.MigrationsFixtureBase, new()
    {
        ...
        [ConditionalFact]
        public virtual Task AddColumnOperation_with_defaultValue_string()
            => Test(
        ...
        [ConditionalFact]
        public virtual Task AddColumnOperation_with_defaultValue_datetime()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
                builder => { },
        ...
        public virtual Task AddColumnOperation_with_fixed_length()
            => Test(
                ...
                model =>
                {
                    ...
                    Assert.Equal(
                        TypeMappingSource
                            .FindMapping(typeof(string), storeTypeName: null, fixedLength: true)
                            .StoreType,
                        column.StoreType);
                });
        ...
        [ConditionalFact]
        public virtual Task AddColumnOperation_with_computedSql()
            => Test(
        ...
        [ConditionalFact]
        public virtual Task AddColumnOperation_with_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
                builder => { },
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_change_type()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_make_required()
            => Test(
                builder => builder.Entity("People", e =>
                {
                    e.Property<int>("Id");
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_make_computed()
            => Test(
                builder => builder.Entity("People", e =>
                    {
                        e.Property<int>("Id");
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_change_computed_with_index()
            => Test(
                builder => builder.Entity("People", e =>
                {
                    e.Property<int>("Id");
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_make_required_with_index()
            => Test(
                builder => builder.Entity("People", e =>
                {
                    e.Property<int>("Id");
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_make_required_with_composite_index()
            => Test(
                builder => builder.Entity("People", e =>
                {
                    e.Property<int>("Id");
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_add_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_change_comment()
            => Test(
        ...
        [ConditionalFact]
        public virtual Task AlterColumnOperation_remove_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id").HasComment("Some comment"),
                builder => builder.Entity("People").Property<int>("Id"),
                model =>
        ...
        [ConditionalFact]
        public virtual Task AlterTableOperation_add_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
                builder => { },
        ...
        [ConditionalFact]
        public virtual Task AlterTableOperation_change_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
        ...
        [ConditionalFact]
        public virtual Task AlterTableOperation_remove_comment()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
                builder => builder.Entity("People").HasComment("Table comment1"),
                builder => { },
        ...
        [ConditionalFact]
        public virtual Task RenameColumnOperation()
            => Test(
                builder => builder.Entity("People").Property<int>("Id"),
        ...
        [ConditionalFact]
        public virtual Task RenameIndexOperation()
            => Test(
                builder => builder.Entity(
                    "People", e =>
                    {
        ...
        [ConditionalFact]
        public virtual Task RenameSequenceOperation()
            => Test(
        ...
        public virtual Task CreateIndexOperation_with_where_clauses()
            => Test(
                ...
                model =>
                {
                    ...
                    Assert.Contains("Age", index.Filter);
                });
        ...
        [ConditionalFact]
        public virtual Task CreateTableOperation()
            => Test(
                builder => { },
                builder => builder.Entity("People", e =>
                    {
        ...
        [ConditionalFact]
        public virtual Task CreateTableOperation_comments()
            => Test(
                builder => { },
                builder => builder.Entity("People", e =>
                    {
        ...
        [ConditionalFact]
        public virtual Task DropColumnOperation_primary_key()
            => Test(
                builder => builder.Entity("People").Property<int>("SomeColumn"),
                builder => builder.Entity("People").Property<int>("Id"),
                builder => { },
        ...
        [ConditionalFact]
        public virtual Task MoveSequenceOperation()
            => Test(
                builder => builder.HasSequence<int>("TestSequence"),
        ...
        [ConditionalFact]
        public virtual Task MoveTableOperation()
            => Test(
        ...
        [ConditionalFact]
        public virtual Task CreateSchemaOperation()
            => Test(
                builder => { },
            ...
            => Test(
                builder => builder.Entity(
                    "Person", e =>
                    {
                        ...
                        e.Property<string>("Name");
                        e.HasData(new Person { Id = 1, AnotherId = 11, Name = "Daenerys Targaryen" });
                    }),
                builder => builder.Entity("Person").HasData(new Person { Id = 2, AnotherId = 12, Name = "John Snow" }),
                builder => { },
                model => { });
        ...
        public virtual Task UpdateDataOperation_composite_key()
            => Test(
                ...
                builder => builder.Entity("Person").HasData(new Person { Id = 2, AnotherId = 11, Name = "John Snow" }),
                builder => builder.Entity("Person").HasData(new Person { Id = 2, AnotherId = 11, Name = "Another John Snow" }),
                model => { });
        ...
        public virtual Task UpdateDataOperation_multiple_columns()
            => Test(
                ...
                builder => builder.Entity("Person").HasData(new Person { Id = 2, Name = "John Snow", Age = 20 }),
                builder => builder.Entity("Person").HasData(new Person { Id = 2, Name = "Another John Snow", Age = 21 }),
                model => { });
        ...
        protected virtual IRelationalTypeMappingSource TypeMappingSource
            => _typeMappingSource ?? throw new InvalidOperationException(
            ...
            Action<DatabaseModel> asserter)
        {
            ...
            try
            {
                ...
                await migrationsCommandExecutor.ExecuteNonQueryAsync(migrationsSqlGenerator.Generate(operations, targetModel), connection);
